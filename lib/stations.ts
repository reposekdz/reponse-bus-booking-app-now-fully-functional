...
export const rwandaAllStations: RwandaStation[] = [
  ...
  { id: 'SP15', name: 'Save', nameRw: 'Save', district: 'Huye', province: 'South', type: 'minor' },
  // Muhanga
  ...
  { id: 'SP16', name: 'Bishenyi', nameRw: 'Bishenyi', district: 'Kamonyi', province: 'South', type: 'minor' },
  // Ruhango
  ...
  { id: 'SP17', name: 'Ndago', nameRw: 'Ndago', district: 'Nyaruguru', province: 'South', type: 'major' },
  // Gisagara
  ...
  { id: 'EP17', name: 'Nasho', nameRw: 'Nasho', district: 'Kirehe', province: 'East', type: 'minor' },
  // Bugesera
